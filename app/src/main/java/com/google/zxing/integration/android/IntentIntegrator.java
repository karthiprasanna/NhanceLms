...
/**
 * <p>
 * A utility class which helps ease integration with Barcode Scanner via {@link Intent}s. This is a
 * simple way to invoke barcode scanning and receive the result, without any need to integrate,
 * modify, or learn the project's source code.
 * </p>
 * 
 * <h2>Initiating a barcode scan</h2>
 * 
 * <p>
 * To integrate, create an instance of {@code IntentIntegrator} and call {@link #initiateScan()} and
 * wait for the result in your app.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * There are a few steps to using this integration. First, your {@link Activity} must implement the
 * method {@link Activity#onActivityResult(int, int, Intent)} and include a line of code like this:
 * </p>
 * 
 * <pre>
 * {@code
 ...
 * 
 * <p>
 * Note that {@link #initiateScan()} returns an {@link AlertDialog} which is non-null if the user
 * was prompted to download the application. This lets the calling app potentially manage the
 * dialog. In particular, ideally, the app dismisses the dialog if it's still active in its
 * {@link Activity#onPause()} method.
 * </p>
 * 
 * <p>
 * You can use {@link #setTitle(String)} to customize the title of this download prompt dialog (or,
 * use {@link #setTitleByID(int)} to set the title by string resource ID.) Likewise, the prompt
 ...
 * PDF417. Use {@link #initiateScan(java.util.Collection)} with a collection containing the names of
...
public class IntentIntegrator {
     ...
     * their names in ZXing's {@code BarcodeFormat} class like "UPC_A". You can supply constants
     ...
     * </p>
     * 
     * @return null if the event handled here was not related to this class, or else an
     *         {@link IntentResult} containing the result of the scan. If the user cancelled
