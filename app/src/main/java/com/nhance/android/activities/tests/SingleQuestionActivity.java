...
import com.nhance.android.async.tasks.SolutionsDowloader;
...
public class SingleQuestionActivity extends NhanceBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d(TAG, "Show Ans Given By User == " + showAnsGiven + ", is true = "
                    + (showAnsGiven == true));
            ansGiven = (TakeTestQuestionWithAnswerGiven) intent
    ...
    private void showLoading() {
        ...
        dialog = new ProgressDialog(SingleQuestionActivity.this);
    ...
    private void setUpWebView() {
        ...
        quesContainer = (WebView) findViewById(R.id.single_question_container);
    ...
    private void setUpButton() {
        ...
        showSolutionBtn.setOnClickListener(new OnClickListener() {
...
//        scroll.fullScroll(direction);
    ...
    private void fetchAndShowSolution() {
        ...
        showLoading();
        SolutionsDowloader solDowloader = new SolutionsDowloader(
        ...
        public void showQues(final boolean showAnsGiven) {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (isDestroyed)
                        return;
                    Log.d(TAG, "options after anno " + question);
                    if(question != null) {
                        ...
                        AttemptStatus attemptStatus = ansGiven.getStatus();
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (entityType.equals(EntityType.VIDEO)) {
                            ...
                            Intent intent = new Intent(SingleQuestionActivity.this,
                            ...
                            Toast.makeText(SingleQuestionActivity.this,
