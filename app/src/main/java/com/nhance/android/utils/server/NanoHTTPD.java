...
public abstract class NanoHTTPD {
     ...
     * 
     * @param parms
     *            original <b>NanoHttpd</b> parameters values, as passed to the <code>serve()</code>
     *            method.
    ...
    /**
     * HTTP Request methods, with the ability to decode a <code>String</code> back to its enum
     * value.
     */
    public enum Method {
     ...
     * files created as a result of handling the request.
     * </p>
     */
     ...
     * <p/>
     * <p>
     * Temp files are responsible for managing the actual temporary storage and cleaning themselves
     ...
     * <code>java.io.tmpdir</code> points to). Files are added to an internal list, and deleted when
     * no longer needed (that is, when <code>clear()</code> is invoked at the end of processing a
     * request).</p>
     */
     ...
     * <p>
     * </p>
     * </[>By default, files are created by <code>File.createTempFile()</code> in the directory
     * specified.</p>
     */
    ...
    public static class Response {
        ...
        private void send(OutputStream outputStream) {
            ...
            try {
                ...
                int pending = data != null ? data.available() : 0; // This is to support partial
                                                                   // sends, see serveFile()
        ...
        public String toString() {
            ...
            builder.append("{status:").append(status).append(", mimeType:").append(mimeType)
                    .append(", header:").append(header).append(", requestMethod:")
    ...
    protected class HTTPSession {
        ...
        public void execute() throws IOException {
            ...
            try {
                ...
                if (splitbyte < rlen) {
                    ByteArrayInputStream splitInputStream = new ByteArrayInputStream(buf,
        ...
        protected void parseBody(Map<String, String> files) throws IOException, ResponseException {
            ...
            try {
                ...
                ByteBuffer fbuf = randomAccessFile.getChannel().map(FileChannel.MapMode.READ_ONLY,
