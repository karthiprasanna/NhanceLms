...
public abstract class AbstractTestFragment extends AbstractVedantuFragment {
    ...
    protected View setQuestionViewPopup(final String courseName,
            final TakeTestQuestionWithAnswerGiven ansGiven) {
        ...
        final View popupQuestionView = getLayoutInflater(null).inflate(
                R.layout.popup_test_your_answer_question_view, null);
        ...
        WebView mWebView = (WebView) popupQuestionView
                .findViewById(R.id.test_question_view_container);

        if (question == null || TextUtils.isEmpty(question.name)) {
            mWebView.setVisibility(View.GONE);
            popupQuestionView.findViewById(R.id.popup_close_button);
            TextView qusNoView = (TextView) popupQuestionView.findViewById(R.id.test_question_no);
    ...
    protected void updatePopupQuestiondData(View popupQuestionLayout, String courseName,
            TakeTestQuestionWithAnswerGiven ansGiven, Question question) {

        ViewUtils.setTextViewValue(popupQuestionLayout, R.id.test_question_course_name, courseName);
        TextView yourAnswerText = (TextView) popupQuestionLayout
                .findViewById(R.id.test_question_your_answer_text);
        TextView yourAnswerValue = (TextView) popupQuestionLayout
                .findViewById(R.id.test_question_your_answer_value);
        yourAnswerValue
        ...
        ViewUtils.setTextViewValue(popupQuestionLayout, R.id.test_question_correct_answer_value,
