...
import com.nhance.android.ChallengeArena.ChallengeExamActivity;
...
public class ChallengeUserExamFragment extends NhanceBaseFragment {
...
//        setQuestionDataFromBundle(getArguments());
      ...
      final String name=bundle.getString("content");
        ...
        question = ((ChallengeExamActivity) getActivity()).getCurrentQuestionData();
        answerGiven = null;
        ...
        public void makeToastToResetAnswer() {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText((ChallengeExamActivity)getActivity(), "To change the answer, reset it first",
