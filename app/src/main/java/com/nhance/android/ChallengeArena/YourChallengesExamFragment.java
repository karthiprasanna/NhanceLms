...
public class YourChallengesExamFragment extends NhanceBaseFragment {
...
//        setQuestionDataFromBundle(getArguments());
      ...
      final String name=bundle.getString("content");
        ...
        question = ((YourChallengesViewActivity) getActivity()).getCurrentQuestionData();
        answerGiven = null;
        ...
        public void makeToastToResetAnswer() {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText((YourChallengesViewActivity)getActivity(), "To change the answer, reset it first",
