...
public class ClosedViewExamFragment extends NhanceBaseFragment {
...
//        setQuestionDataFromBundle(getArguments());
      ...
      final String name=bundle.getString("content");
        ...
        question = ((ClosedViewChallengeActivity) getActivity()).getCurrentQuestionData();
        answerGiven = null;
        ...
        public void makeToastToResetAnswer() {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText((ClosedViewChallengeActivity)getActivity(), "To change the answer, reset it first",
