...
public class UserExamFragment extends NhanceBaseFragment {

    private static final String    TAG = "UserExamFragment";
...
//        setQuestionDataFromBundle(getArguments());
      ...
      final String name=bundle.getString("content");
        ...
        question = ((UserExamActivity) getActivity()).getCurrentQuestionData();
        answerGiven = null;
...
//                    if (notifyTakeTestActivity != null) {
                    ((UserExamActivity)getActivity()).setAnswerForCurrentQuestion(answer);
//                    }
                }
            });
        }
        ...
        public void makeToastToResetAnswer() {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText((UserExamActivity)getActivity(), "To change the answer, reset it first",
