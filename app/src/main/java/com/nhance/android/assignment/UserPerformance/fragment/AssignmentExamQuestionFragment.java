...
public class AssignmentExamQuestionFragment extends NhanceBaseFragment {
...
//        setQuestionDataFromBundle(getArguments());
      ...
      final String name=bundle.getString("content");
        ...
        question = ((StudentAssignmentActivity) getActivity()).getCurrentQuestionData();
        answerGiven = null;
        ...
        public void makeToastToResetAnswer() {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText((StudentAssignmentActivity)getActivity(), "To change the answer, reset it first",
