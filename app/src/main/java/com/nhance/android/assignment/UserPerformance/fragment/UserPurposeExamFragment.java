package com.nhance.android.assignment.UserPerformance.fragment;
...
import com.nhance.android.assignment.UserPerformance.StudentAssignmentActivity;
...
public class UserPurposeExamFragment extends NhanceBaseFragment {
...
//        setQuestionDataFromBundle(getArguments());
      ...
      final String name=bundle.getString("content");
        ...
        question = ((UserPurposeAssignmentActivity) getActivity()).getCurrentQuestionData();
        answerGiven = null;
        ...
        public void makeToastToResetAnswer() {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText((UserPurposeAssignmentActivity)getActivity(), "To change the answer, reset it first",
