...
import com.nhance.android.assignment.TeacherPerformance.TeacherPurposeExamActivity;
...
public class TeacherPurposeExamFragment extends NhanceBaseFragment {
...
//        setQuestionDataFromBundle(getArguments());
      ...
      final String name=bundle.getString("content");
        ...
        question = ((TeacherPurposeExamActivity) getActivity()).getCurrentQuestionData();
        answerGiven = null;
        ...
        public void makeToastToResetAnswer() {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText((TeacherPurposeExamActivity)getActivity(), "To change the answer, reset it first",
