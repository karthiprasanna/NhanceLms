...
public class AssignmentDownloader extends AbstractAssignmentDownloader {

    private final String TAG                 = "AssignmentDownloader";
    ...
    public AssignmentDownloader(Content content, Context context,
                                IDownloadCompleteProcessor<JSONObject> downloadCompleteProcessor) {
