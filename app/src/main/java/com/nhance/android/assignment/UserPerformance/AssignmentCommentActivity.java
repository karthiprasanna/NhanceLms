...
public class AssignmentCommentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // getSupportActionBar().setIcon(R.drawable.ic_launcher);
        ...
        if(NetUtils.isOnline(AssignmentCommentActivity.this)) {
            new getComments().execute();
        }else{
            Toast.makeText(AssignmentCommentActivity.this, R.string.no_internet_msg, Toast.LENGTH_SHORT).show();
        }
                ...
                if(NetUtils.isOnline(AssignmentCommentActivity.this)) {
                    if (!post_comment.getText().toString().trim().isEmpty()) {
                       ...
                       new addSolution(session).execute();
                        ...
                        emptyEditText = false;
                        Toast.makeText(AssignmentCommentActivity.this,"Please enter the comment",Toast.LENGTH_LONG).show();
    ...
    class  getComments extends AsyncTask<JSONObject, JSONObject, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = new ProgressDialog(AssignmentCommentActivity.this);
